        ...
        <div class="table-custom">
            <table class="theme-table" id="table_id">
                ...
                <tbody>
                    ...
                    <?php foreach ($dataAttributeValue as $dataAttributeValueItem) {
                        extract($dataAttributeValueItem);
                        // Kiểm tra xem $attributeItem có tồn tại và có key 'id' không
                        $attributeItemId = isset($attributeItem['id']) ? $attributeItem['id'] : null;
                    ?>
                        <tr>
                            <td class="text-capitalize"><?= $name ?></td>
                            <td class="fw-bold "><?= $value_name ?></td>
                            ...
                            <td>
                                <ul class="options">
                                    ...
                                    <li class="m-0 ">
                                        <?php if ($attributeItemId !== null) : ?>
                                            <a onclick="setDataIdToInput(<?= $id ?>)" href="javascript:void(0)" data-id="<?= $attributeItemId ?>" data-bs-toggle="modal" data-bs-target="#deleteConfirm">
                                                <i class="delete fas fa-trash-alt"></i>
                                            </a>
                                        <?php endif; ?>
                                    </li>
